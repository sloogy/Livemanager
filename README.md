# LifePlanner 0.5.4 – Multi-Repository-Plattform mit GitHub-Modulinstaller
...
Ein Tag wie `lifeplanner-v0.5.4` baut aus den drei getrennten Checkouts:

- `LifePlanner_0.5.4_Windows_Portable.zip`
- `LifePlanner_Core_0.5.4_Windows_x86_64.zip`
...
- `LifePlanner_0.5.4_Windows_Setup.exe`
