...
Ein Tag wie `lifeplanner-v0.6.1` baut aus den drei getrennten Checkouts:

- `LifePlanner_0.6.1_Windows_Portable.zip`
- `LifePlanner_Core_0.6.1_Windows_x86_64.lpupdate`
- `budgetmanager_2.4.0_Windows_x86_64.lpmodule`
- `fpm_1.4.0_Windows_x86_64.lpmodule`
- `freizeitmanager_0.2.1_Windows_x86_64.lpmodule`
- `LifePlanner_0.6.1_Windows_Setup.exe`
